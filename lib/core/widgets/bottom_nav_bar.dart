        ...
        child: Theme(
          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              _buildNavItem(Svgs.libraryIcon, 1),
              _buildNavItem(Svgs.searchIcon, 2),
              _buildNavItem(Svgs.communityIcon, 3),
              _buildNavItem(Svgs.settingIcon, 3),
            ],
          ),
        ),
      ),
    ...
    return BottomNavigationBarItem(
      icon: SvgPicture.asset(
        ...
        colorFilter: ColorFilter.mode(
          selectedIndex == index ? Colors.black : AppColors.lightGray,
          BlendMode.srcIn,
        ),
      ),
      label: '',
