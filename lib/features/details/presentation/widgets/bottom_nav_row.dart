...
class _BottomNavRowState extends State<BottomNavRow> {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ElevatedButton(
          onPressed: () => setState(() => isWatchNow = false),
          style: ButtonStyle(
            backgroundColor: WidgetStateProperty.all(
              isWatchNow ? AppColors.bottonAnimeTypeColor : AppColors.mainBlue,
            ),
        ...
        ElevatedButton(
          onPressed: () => setState(() => isWatchNow = true),
          style: ButtonStyle(
            backgroundColor: WidgetStateProperty.all(
              isWatchNow ? AppColors.mainBlue : AppColors.bottonAnimeTypeColor,
            ),
            minimumSize: WidgetStateProperty.all(Size(40, 30)),
          ),
          child: Row(
